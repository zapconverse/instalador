...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador Zapconverse, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar Zapconverse\n"
  printf "   [1] Atualizar Zapconverse\n"
  printf "   [2] Deletar Zapconverse\n"
  printf "   [3] Bloquear Zapconverse\n"
  printf "   [4] Desbloquear Zapconverse\n"
  printf "   [5] Alter. dominio Zapconverse\n"
  printf "\n"
  read -p "> " option
